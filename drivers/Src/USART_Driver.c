...
#ifndef INC_USART_DRIVER_C_
#define INC_USART_DRIVER_C_
...
/******************************** Configuration of CR1******************************************/
	...
	if ( pUSARTHandle->USART_Config.USART_ParityControl == USART_PARITY_EN_EVEN)
	{
		...
		tempreg &=~( 1 << USART_CR1_PS); //clearing the field to make sure that it is in fact EVEN parity
		pUSARTHandle->pUSARTx->USART_CR1|=tempreg;
		tempreg=0;
